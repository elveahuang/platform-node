...
export interface ApiCatalogCatalog extends Schema.CollectionType {
    ...
    attributes: {
        ...
        root: Attribute.Boolean & Attribute.DefaultTo<false>;
        catalog: Attribute.Relation<'api::catalog.catalog', 'oneToOne', 'api::catalog.catalog'>;
        content: Attribute.RichText;
        createdAt: Attribute.DateTime;
        updatedAt: Attribute.DateTime;
        publishedAt: Attribute.DateTime;
        createdBy: Attribute.Relation<'api::catalog.catalog', 'oneToOne', 'admin::user'> & Attribute.Private;
        updatedBy: Attribute.Relation<'api::catalog.catalog', 'oneToOne', 'admin::user'> & Attribute.Private;
    };
}

export interface ApiCatalogTypeCatalogType extends Schema.CollectionType {
    collectionName: 'catalog_types';
    info: {
        singularName: 'catalog-type';
        pluralName: 'catalog-types';
    ...
    attributes: {
        ...
        createdAt: Attribute.DateTime;
        updatedAt: Attribute.DateTime;
        createdBy: Attribute.Relation<'api::catalog-type.catalog-type', 'oneToOne', 'admin::user'> & Attribute.Private;
        updatedBy: Attribute.Relation<'api::catalog-type.catalog-type', 'oneToOne', 'admin::user'> & Attribute.Private;
        localizations: Attribute.Relation<'api::catalog-type.catalog-type', 'oneToMany', 'api::catalog-type.catalog-type'>;
...
export interface ApiTagTypeTagType extends Schema.CollectionType {
    collectionName: 'tag_types';
    info: {
    ...
    attributes: {
        ...
        updatedAt: Attribute.DateTime;
        publishedAt: Attribute.DateTime;
        createdBy: Attribute.Relation<'api::tag-type.tag-type', 'oneToOne', 'admin::user'> & Attribute.Private;
        updatedBy: Attribute.Relation<'api::tag-type.tag-type', 'oneToOne', 'admin::user'> & Attribute.Private;
    };
}
...
declare module '@strapi/strapi' {
    export module Shared {
        export interface ContentTypes {
            ...
            'api::catalog-type.catalog-type': ApiCatalogTypeCatalogType;
            'api::config.config': ApiConfigConfig;
            'api::new.new': ApiNewNew;
            'api::tag.tag': ApiTagTag;
            'api::tag-type.tag-type': ApiTagTypeTagType;
        }
    }
}
